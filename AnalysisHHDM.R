...
library("ivreg")
########################################################################
# Step 1.Map system folders to different users
######################################################################## 
sysinf <- Sys.info()
uname <- sysinf['user']
if (!is.null(sysinf)){
...
######################################################################## 
data1<-read_dta(file=paste0(getwd(),raw,"/midline_merged_anon_1.dta"))
data2<-read_dta(file=paste0(getwd(),raw,"/midline_merged_anon_2.dta"))
data3<-read_dta(file=paste0(getwd(),raw,"/midline_merged_anon_3.dta"))
########################################################################
# Step 3.Merging Datafiles
######################################################################## 
